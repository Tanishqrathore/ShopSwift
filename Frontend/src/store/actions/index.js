...
export const addToCart =
  ...
  (dispatch, getState) => {
    ...
    if (isProductExist) {
      toast.error(`${data?.productName} is already present in cart`);
      return;
    }
...
export const clearCart = () => async (dispatch) => {
  localStorage.removeItem('cartItems'); // 🗑️ Local storage se cart hatao
  dispatch({ type: 'CLEAR_CART' }); // 🔄 Redux store se cart hatao
};
